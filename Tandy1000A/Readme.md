...
generator, U46 System Timing Synthesizer PAL and other discrete control/timing logic. Unfortunately
the pinout appears to be very different from the similar, documented, timing control generator used
in the 1000 SX.
